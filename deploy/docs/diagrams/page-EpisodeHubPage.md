# Vertical Slice: EpisodeHubPage

**Files**: deploy/new_html/pages/EpisodeHubPage.tsx, new_html/pages/EpisodeHubPage.tsx
...
flowchart LR
  ...
  subgraph FE["Frontend - EpisodeHubPage"]
    fe_deploy_new_html_pages_EpisodeHubPage_tsx["EpisodeHubPage.tsx"]:::fe
    fe_new_html_pages_EpisodeHubPage_tsx["EpisodeHubPage.tsx"]:::fe
  end
  ...
  fe_deploy_new_html_pages_EpisodeHubPage_tsx --> be_POST__api_assets
  fe_deploy_new_html_pages_EpisodeHubPage_tsx --> be_POST__api_character_voices
  fe_deploy_new_html_pages_EpisodeHubPage_tsx --> be_POST__api_notifications_read_all
  fe_deploy_new_html_pages_EpisodeHubPage_tsx --> be_POST__api_projects_save
  ...
  fe_deploy_new_html_pages_EpisodeHubPage_tsx -.-> ch_storage_auth_token
  fe_deploy_new_html_pages_EpisodeHubPage_tsx -.-> ch_storage_username
```
