# Vertical Slice: CanvasPage

**Files**: deploy/new_html/pages/CanvasPage.tsx, new_html/pages/CanvasPage.tsx
...
flowchart LR
  ...
  subgraph FE["Frontend - CanvasPage"]
    fe_deploy_new_html_pages_CanvasPage_tsx["CanvasPage.tsx"]:::fe
    fe_new_html_pages_CanvasPage_tsx["CanvasPage.tsx"]:::fe
  end
  ...
  fe_deploy_new_html_pages_CanvasPage_tsx --> be_POST__api_assets
  fe_deploy_new_html_pages_CanvasPage_tsx --> be_POST__api_character_voices
  fe_deploy_new_html_pages_CanvasPage_tsx --> be_POST__api_notifications_read_all
  fe_deploy_new_html_pages_CanvasPage_tsx --> be_POST__api_projects_save
  ...
  subgraph CH["Cross-page channels"]
    ...
    ch_provider_ReactFlowProvider(("provider:ReactFlowProvider")):::ch
    ch_storage_auth_token(("storage:auth_token")):::ch
    ch_storage_username(("storage:username")):::ch
  end
  fe_deploy_new_html_pages_CanvasPage_tsx -.-> ch_context_EpisodeContext
  fe_deploy_new_html_pages_CanvasPage_tsx -.-> ch_provider_EpisodeProvider
  fe_deploy_new_html_pages_CanvasPage_tsx -.-> ch_provider_ReactFlowProvider
  fe_deploy_new_html_pages_CanvasPage_tsx -.-> ch_storage_auth_token
  fe_deploy_new_html_pages_CanvasPage_tsx -.-> ch_storage_username
```
