# Vertical Slice: CreditsPage

**Files**: deploy/new_html/pages/CreditsPage.tsx, new_html/pages/CreditsPage.tsx
...
flowchart LR
  ...
  subgraph FE["Frontend - CreditsPage"]
    fe_deploy_new_html_pages_CreditsPage_tsx["CreditsPage.tsx"]:::fe
    fe_new_html_pages_CreditsPage_tsx["CreditsPage.tsx"]:::fe
  end
  ...
  fe_deploy_new_html_pages_CreditsPage_tsx --> be_POST__api_assets
  fe_deploy_new_html_pages_CreditsPage_tsx --> be_POST__api_character_voices
  fe_deploy_new_html_pages_CreditsPage_tsx --> be_POST__api_notifications_read_all
  fe_deploy_new_html_pages_CreditsPage_tsx --> be_POST__api_projects_save
  ...
  fe_deploy_new_html_pages_CreditsPage_tsx -.-> ch_storage_auth_token
  fe_deploy_new_html_pages_CreditsPage_tsx -.-> ch_storage_username
```
