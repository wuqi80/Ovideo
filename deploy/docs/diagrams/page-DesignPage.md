# Vertical Slice: DesignPage

**Files**: deploy/new_html/pages/DesignPage.tsx, new_html/pages/DesignPage.tsx
...
flowchart LR
  ...
  subgraph FE["Frontend - DesignPage"]
    fe_deploy_new_html_pages_DesignPage_tsx["DesignPage.tsx"]:::fe
    fe_new_html_pages_DesignPage_tsx["DesignPage.tsx"]:::fe
  end
  ...
  subgraph BE["Backend"]
    ...
    be_POST__api_gemini_text["POST /api/gemini/text\n[gemini_text_chat]"]:::be
  ...
  fe_deploy_new_html_pages_DesignPage_tsx --> be_POST__api_assets
  fe_deploy_new_html_pages_DesignPage_tsx --> be_POST__api_character_voices
  fe_deploy_new_html_pages_DesignPage_tsx --> be_POST__api_deepseek_chat
  fe_deploy_new_html_pages_DesignPage_tsx --> be_POST__api_gemini_image
  fe_deploy_new_html_pages_DesignPage_tsx --> be_POST__api_gemini_text
  fe_deploy_new_html_pages_DesignPage_tsx --> be_POST__api_materials_doubao
  fe_deploy_new_html_pages_DesignPage_tsx --> be_POST__api_notifications_read_all
  fe_deploy_new_html_pages_DesignPage_tsx --> be_POST__api_projects_save
  ...
  be_POST__api_gemini_text --> db_tasks
  ...
  fe_deploy_new_html_pages_DesignPage_tsx -.-> ch_context_EpisodeContext
  fe_deploy_new_html_pages_DesignPage_tsx -.-> ch_storage_auth_token
  fe_deploy_new_html_pages_DesignPage_tsx -.-> ch_storage_username
```
