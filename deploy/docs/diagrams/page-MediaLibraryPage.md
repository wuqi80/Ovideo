# Vertical Slice: MediaLibraryPage

**Files**: deploy/new_html/pages/MediaLibraryPage.tsx, new_html/pages/MediaLibraryPage.tsx
...
flowchart LR
  ...
  subgraph FE["Frontend - MediaLibraryPage"]
    fe_deploy_new_html_pages_MediaLibraryPage_tsx["MediaLibraryPage.tsx"]:::fe
    fe_new_html_pages_MediaLibraryPage_tsx["MediaLibraryPage.tsx"]:::fe
  end
  ...
  fe_deploy_new_html_pages_MediaLibraryPage_tsx --> be_POST__api_assets
  fe_deploy_new_html_pages_MediaLibraryPage_tsx --> be_POST__api_character_voices
  fe_deploy_new_html_pages_MediaLibraryPage_tsx --> be_POST__api_notifications_read_all
  fe_deploy_new_html_pages_MediaLibraryPage_tsx --> be_POST__api_projects_save
  ...
  fe_deploy_new_html_pages_MediaLibraryPage_tsx -.-> ch_storage_auth_token
  fe_deploy_new_html_pages_MediaLibraryPage_tsx -.-> ch_storage_username
```
