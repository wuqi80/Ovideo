# Vertical Slice: AdminPage

**Files**: deploy/new_html/components/AdminPage.tsx, new_html/components/AdminPage.tsx
...
flowchart LR
  ...
  subgraph FE["Frontend - AdminPage"]
    fe_deploy_new_html_components_AdminPage_tsx["AdminPage.tsx"]:::fe
    fe_new_html_components_AdminPage_tsx["AdminPage.tsx"]:::fe
  end
  ...
  fe_deploy_new_html_components_AdminPage_tsx --> be_POST__api_assets
  fe_deploy_new_html_components_AdminPage_tsx --> be_POST__api_character_voices
  fe_deploy_new_html_components_AdminPage_tsx --> be_POST__api_notifications_read_all
  fe_deploy_new_html_components_AdminPage_tsx --> be_POST__api_projects_save
  ...
  fe_deploy_new_html_components_AdminPage_tsx -.-> ch_storage_auth_token
  fe_deploy_new_html_components_AdminPage_tsx -.-> ch_storage_username
```
