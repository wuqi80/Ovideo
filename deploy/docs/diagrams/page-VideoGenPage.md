# Vertical Slice: VideoGenPage

**Files**: deploy/new_html/pages/VideoGenPage.tsx, new_html/pages/VideoGenPage.tsx
...
flowchart LR
  ...
  subgraph FE["Frontend - VideoGenPage"]
    fe_deploy_new_html_pages_VideoGenPage_tsx["VideoGenPage.tsx"]:::fe
    fe_new_html_pages_VideoGenPage_tsx["VideoGenPage.tsx"]:::fe
  end
  ...
  fe_deploy_new_html_pages_VideoGenPage_tsx --> be_POST__api_assets
  fe_deploy_new_html_pages_VideoGenPage_tsx --> be_POST__api_character_voices
  fe_deploy_new_html_pages_VideoGenPage_tsx --> be_POST__api_notifications_read_all
  fe_deploy_new_html_pages_VideoGenPage_tsx --> be_POST__api_projects_save
  ...
  fe_deploy_new_html_pages_VideoGenPage_tsx -.-> ch_context_EpisodeContext
  fe_deploy_new_html_pages_VideoGenPage_tsx -.-> ch_storage_auth_token
  fe_deploy_new_html_pages_VideoGenPage_tsx -.-> ch_storage_current_project_id
  fe_deploy_new_html_pages_VideoGenPage_tsx -.-> ch_storage_username
```
