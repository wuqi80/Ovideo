# Vertical Slice: PostProcessPage

**Files**: deploy/new_html/components/PostProcessPage.tsx, new_html/components/PostProcessPage.tsx
...
flowchart LR
  ...
  subgraph FE["Frontend - PostProcessPage"]
    fe_deploy_new_html_components_PostProcessPage_tsx["PostProcessPage.tsx"]:::fe
    fe_new_html_components_PostProcessPage_tsx["PostProcessPage.tsx"]:::fe
  end
  ...
  fe_deploy_new_html_components_PostProcessPage_tsx --> be_POST__api_assets
  fe_deploy_new_html_components_PostProcessPage_tsx --> be_POST__api_character_voices
  fe_deploy_new_html_components_PostProcessPage_tsx --> be_POST__api_notifications_read_all
  fe_deploy_new_html_components_PostProcessPage_tsx --> be_POST__api_projects_save
  ...
  fe_deploy_new_html_components_PostProcessPage_tsx -.-> ch_context_ProjectContext
  fe_deploy_new_html_components_PostProcessPage_tsx -.-> ch_storage_auth_token
  fe_deploy_new_html_components_PostProcessPage_tsx -.-> ch_storage_username
```
