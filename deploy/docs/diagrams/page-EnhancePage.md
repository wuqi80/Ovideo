# Vertical Slice: EnhancePage

**Files**: deploy/new_html/pages/EnhancePage.tsx, new_html/pages/EnhancePage.tsx
...
flowchart LR
  ...
  subgraph FE["Frontend - EnhancePage"]
    fe_deploy_new_html_pages_EnhancePage_tsx["EnhancePage.tsx"]:::fe
    fe_new_html_pages_EnhancePage_tsx["EnhancePage.tsx"]:::fe
  end
  ...
  fe_deploy_new_html_pages_EnhancePage_tsx --> be_POST__api_assets
  fe_deploy_new_html_pages_EnhancePage_tsx --> be_POST__api_character_voices
  fe_deploy_new_html_pages_EnhancePage_tsx --> be_POST__api_notifications_read_all
  fe_deploy_new_html_pages_EnhancePage_tsx --> be_POST__api_projects_save
  ...
  fe_deploy_new_html_pages_EnhancePage_tsx -.-> ch_context_EpisodeContext
  fe_deploy_new_html_pages_EnhancePage_tsx -.-> ch_storage_auth_token
  fe_deploy_new_html_pages_EnhancePage_tsx -.-> ch_storage_username
```
