# Vertical Slice: VideoReversePage

**Files**: deploy/new_html/pages/VideoReversePage.tsx, new_html/pages/VideoReversePage.tsx
...
flowchart LR
  ...
  subgraph FE["Frontend - VideoReversePage"]
    fe_deploy_new_html_pages_VideoReversePage_tsx["VideoReversePage.tsx"]:::fe
    fe_new_html_pages_VideoReversePage_tsx["VideoReversePage.tsx"]:::fe
  end
  ...
  fe_deploy_new_html_pages_VideoReversePage_tsx --> be_POST__api_assets
  fe_deploy_new_html_pages_VideoReversePage_tsx --> be_POST__api_character_voices
  fe_deploy_new_html_pages_VideoReversePage_tsx --> be_POST__api_notifications_read_all
  fe_deploy_new_html_pages_VideoReversePage_tsx --> be_POST__api_projects_save
  ...
  fe_deploy_new_html_pages_VideoReversePage_tsx -.-> ch_storage_auth_token
  fe_deploy_new_html_pages_VideoReversePage_tsx -.-> ch_storage_username
```
