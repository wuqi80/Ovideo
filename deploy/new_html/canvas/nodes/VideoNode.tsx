...
export const VideoNode = memo(({ data, id }: NodeProps) => {
  ...
  return (
    <div style={{
      ...
      <Handle id="in" type="target" position={Position.Left} isConnectable style={{ ...handleStyle, background: '#e91e63' }} />
      ...
      <Handle id="out" type="source" position={Position.Right} isConnectable style={{ ...handleStyle, background: '#e91e63' }} />
    </div>
  );
});
